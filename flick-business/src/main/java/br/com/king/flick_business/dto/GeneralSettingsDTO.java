...
public record GeneralSettingsDTO(
                ...
                @Size(max = 50, message = "Máximo de 50 caracteres") @NotBlank(message = "Campo obrigatório") @NotNull(message = "Campo obrigatório") @Pattern(regexp = "[A-Za-z0-9 ]+", message = "Inválido. (ex: Loja do João)") String nameNegocio) {
}